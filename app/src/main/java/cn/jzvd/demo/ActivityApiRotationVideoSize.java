...
public class ActivityApiRotationVideoSize extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myJZVideoPlayerStandard = (JZVideoPlayerStandard) findViewById(R.id.jz_video);
        ...
        mBtnRotation = (Button) findViewById(R.id.rotation_to_90);
        mBtnFillParent = (Button) findViewById(R.id.video_image_display_fill_parent);
        mBtnFillCrop = (Button) findViewById(R.id.video_image_display_fill_crop);
        mBtnOriginal = (Button) findViewById(R.id.video_image_diaplay_original);
